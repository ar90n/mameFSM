...
using SubTransition = std::variant<mameFSM::Transition<SubWalk>, mameFSM::Transition<SubRun>>;

using ParentTransition =
    std::variant<mameFSM::Transition<IdleState>, mameFSM::Transition<MovingState>>;
